...
namespace Appscore\LatestNews\Block\Adminhtml\Categories;
...
class Edit extends Container
{
   /**
    ...
    {
        $newsRegistry = $this->_coreRegistry->registry('latestnews_categories');
        if ($newsRegistry->getId()) {
            $newsTitle = $this->escapeHtml($newsRegistry->getTitle());
            return __("Edit Category '%1'", $newsTitle);
        } else {
